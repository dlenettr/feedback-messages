...
if ( $_REQUEST['action'] == "install" ) {
	...
	$sql = array();
	$sql[] = "DROP TABLE IF EXISTS " . PREFIX . "_feedbacks";
	$sql[] = "CREATE TABLE IF NOT EXISTS " . PREFIX . "_feedbacks (
	`id` int(10) unsigned NOT NULL auto_increment,
	`username_from` varchar(120) NOT NULL,
	`username_to` varchar(40) NOT NULL,
	`text` text NOT NULL,
...
HTML;
	...
	$sql[] = "TRUNCATE TABLE " . PREFIX . "_feedbacks";
